package com.tutorialsninja.com.qa.listeners;
...
import com.tutorialsninja.com.qa.Utils.ExtendReporter;
...
public class MyListeners implements ITestListener {
	...
	public void onStart(ITestContext context) {
		...
		extentReport = ExtendReporter.generateExtendReport();
	}
	...
	public void onFinish(ITestContext context) {
		...
		extentReport.flush();
		  ...
		  try { Desktop.getDesktop().browse(extentReport.toURI()); } catch (IOException e) { e.printStackTrace(); }
